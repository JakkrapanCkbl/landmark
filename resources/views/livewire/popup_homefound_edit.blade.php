                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 d-flex mb-4">
                            <p class="m-0 wp-30 text-muted">รหัสรัพย์สิน</p>
                            <p class="m-0 wp-70 text-dark">{{$myid}}</p>
                        </div>
                        <div class="col-md-12 d-flex mb-4">
                            <p class="m-0 wp-30 text-muted">ชื่อสถานที่</p>
                            <p class="m-0 wp-70 text-dark">{{$prop_name}}</p>
                        </div>
                        <div class="col-md-12 d-flex mb-4">
                            <p class="m-0 wp-30 text-muted">ทำเลที่ตั้ง</p>
                            <p class="m-0 wp-70 text-dark">{{$prop_location}}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer p-0 border-top-0">
                    ...
                    <div class="tabs-menu4 w-100">
                        <nav class="nav border-bottom px-4 d-block d-lg-flex flex-2">
                            ...
                            <a class="nav-link border border-bottom-0 py-1 br-5 mx-1 mx-md-1" data-bs-toggle="tab" href="#task-disclaim">
                                เอกสารสละสิทธิ์ที่ดิน
                            </a>
                            <a class="nav-link border border-bottom-0 py-1 br-5 mx-1 mx-md-1" data-bs-toggle="tab" href="#task-building">
                                เอกสารอาคาร
                            </a>
                            <a class="nav-link border border-bottom-0 py-1 br-5 mx-1 mx-md-1" data-bs-toggle="tab" href="#task-appendix">
                                Appendix
                            </a>
                            <a class="nav-link border border-bottom-0 py-1 br-5 mx-1 mx-md-1" data-bs-toggle="tab" href="#task-other">
                                อื่นๆ
                            </a>
                    ...
                    <div class="tab-content w-100">
                        <div class="tab-pane active task-files-tab" id="task-files">
                            <div class="row">
                                <form action="{{route('dropzone.dz_storefoundationfiles')}}" method="POST" enctype="multipart/form-data" id="files-upload" class="dropzone">
									@csrf
                                    ...
                                    <input type="hidden" id="doc_type" name="doc_type" value="deed">
								</form>
                            </div>
                            <div class="row">
                                <div class="mt-3">
                                                ...
                                                @foreach ($job_imgs as $job_img)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            <a href="{{ route('deletefoundationfile',[$myid,$job_img->file_name]) }}"><i class="fe fe-trash delete-main text-muted"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
                        ...
                        <div class="tab-pane" id="task-landindex">
                           <div class="row">
                                <form action="{{route('dropzone.dz_storefoundationfiles')}}" method="POST" enctype="multipart/form-data" id="files-upload" class="dropzone">
									@csrf
									<input type="hidden" id="jobid" name="jobid" value={{$myid}}>
									<input type="hidden" id="mainfolder" name="mainfolder" value={{$mainfolder}}>
									<input type="hidden" id="subfolder" name="subfolder" value={{$subfolder}}>
                                    <input type="hidden" id="doc_type" name="doc_type" value="landindex">
								</form>
                            </div>
                            <div class="row">
                                <div class="mt-3">
                        ...
                        <div class="tab-pane" id="task-disclaim">
                           <div class="row">
                                <form action="{{route('dropzone.dz_storefoundationfiles')}}" method="POST" enctype="multipart/form-data" id="files-upload" class="dropzone">
									...
									<input type="hidden" id="mainfolder" name="mainfolder" value={{$mainfolder}}>
									<input type="hidden" id="subfolder" name="subfolder" value={{$subfolder}}>
                                    <input type="hidden" id="doc_type" name="doc_type" value="disclaim">
								</form>
                            </div>
                            <div class="row">
                                <div class="mt-3">
                        ...
                        <div class="tab-pane" id="task-building">
                           <div class="row">
                                <form action="{{route('dropzone.dz_storefoundationfiles')}}" method="POST" enctype="multipart/form-data" id="files-upload" class="dropzone">
									@csrf
									<input type="hidden" id="jobid" name="jobid" value={{$myid}}>
									<input type="hidden" id="mainfolder" name="mainfolder" value={{$mainfolder}}>
									<input type="hidden" id="subfolder" name="subfolder" value={{$subfolder}}>
                                    <input type="hidden" id="doc_type" name="doc_type" value="building">
								</form>
                            </div>
                            <div class="row">
                                <div class="mt-3">
                        ...
                        <div class="tab-pane" id="task-appendix">
                           <div class="row">
                                <form action="{{route('dropzone.dz_storefoundationfiles')}}" method="POST" enctype="multipart/form-data" id="files-upload" class="dropzone">
									@csrf
									<input type="hidden" id="jobid" name="jobid" value={{$myid}}>
									<input type="hidden" id="mainfolder" name="mainfolder" value={{$mainfolder}}>
									<input type="hidden" id="subfolder" name="subfolder" value={{$subfolder}}>
                                    <input type="hidden" id="doc_type" name="doc_type" value="appendix">
								</form>
                            </div>
                            <div class="row">
                                <div class="mt-3">
                         ...
                         <div class="tab-pane" id="task-other">
                           <div class="row">
                                <form action="{{route('dropzone.dz_storefoundationfiles')}}" method="POST" enctype="multipart/form-data" id="files-upload" class="dropzone">
									@csrf
									<input type="hidden" id="jobid" name="jobid" value={{$myid}}>
									<input type="hidden" id="mainfolder" name="mainfolder" value={{$mainfolder}}>
									<input type="hidden" id="subfolder" name="subfolder" value={{$subfolder}}>
                                    <input type="hidden" id="doc_type" name="doc_type" value="other">
								</form>
                            </div>
                            <div class="row">
                                <div class="mt-3">
