<!--TASK MODAL-->
    <div wire:ignore.self class="modal fade" id="PopupCityplanAddData">
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <table class="table text-nowrap text-md-nowrap table-bordered">
                            <tbody>
                                <tr>
                                    <td class="wp-30">doc_group, asa_no</td>
                                    <td class="wp-70">
                                        <div class="row">
                    ...
                    <div class="modal-footer p-0 border-top-0">
                        <div class="row">
                            {{-- <div class="col-md-12 d-flex mb-4">
                                ...
                                <p class="m-0 wp-50 text-dark"><button class="btn btn-primary" type="submit">บันทึกข้อมูล</button></p>
                            </div>
                            <div class="col-md-12 d-flex mb-4">
                                <p class="m-0 wp-50 text-muted"></p>
