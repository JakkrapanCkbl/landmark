                ...
                <div class="modal-footer p-0 border-top-0">
                    ...
                    <div class="tabs-menu4 w-100">
                        <nav class="nav border-bottom px-4 d-block d-lg-flex flex-2">
                            <a class="nav-link border border-bottom-0 py-1 br-5 mx-1 mx-md-1 active" data-bs-toggle="tab" href="#task-maps">
                            ...
                            <a class="nav-link border border-bottom-0 py-1 br-5 mx-1 mx-md-1" data-bs-toggle="tab" href="#task-files">
                                @if (is_null($job_imgs) || empty($job_imgs))
                                    PDF ต้นฉบับ
                                @else
                                    <p style="font-weight: bold; color: blue;">PDF ต้นฉบับ</p>
                                @endif
                            </a>
                            <a class="nav-link border border-bottom-0 py-1 br-5 mx-1 mx-md-1" data-bs-toggle="tab" href="#task-landindex">
                                @if (is_null($landindex) || empty($landindex))
                                    Word
                                @else
                                    <p style="font-weight: bold; color: blue;">Word</p>
                                @endif
                            </a>
                            <a class="nav-link border border-bottom-0 py-1 br-5 mx-1 mx-md-1" data-bs-toggle="tab" href="#task-disclaim">
                                @if (is_null($disclaim) || empty($disclaim))
                                    PDF แนบรายงาน
                                @else
                                    <p style="font-weight: bold; color: blue;">PDF แนบรายงาน</p>
                                @endif
                            </a>
                    ...
                    <div class="tab-content w-100">
                        <div class="tab-pane active task-files-tab" id="task-maps">
                            <div class="row">
                                <form action="{{route('dropzone.dz_storecityplanfiles')}}" method="POST" enctype="multipart/form-data" id="files-upload" class="dropzone">
                                    ...
                                    <input type="hidden" id="doc_type" name="doc_type" value="cityplan_map">
								</form>
                            </div>
                            <div class="row">
                                <div class="mt-3">
                                                ...
                                                @foreach ($job_maps as $job_img)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            <a href="{{ route('deletecityplanfile',[$myid,$job_img->file_name,"cityplan_map"]) }}"><i class="fe fe-trash delete-main text-muted"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
                        ...
                        <div class="tab-pane task-files-tab" id="task-files">
                            <div class="row">
                                <form action="{{route('dropzone.dz_storecityplanfiles')}}" method="POST" enctype="multipart/form-data" id="files-upload" class="dropzone">
									@csrf
									<input type="hidden" id="jobid" name="jobid" value={{$myid}}>
