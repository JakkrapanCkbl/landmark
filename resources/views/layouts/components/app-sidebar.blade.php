                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
							...
							<li class="slide">
								<a class="side-menu__item has-link" data-bs-toggle="slide" href="{{url('dashboard')}}">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="{{ route('building_law') }}" class="slide-item">กฏหมายควบคุมอาคาร</a></li>
                                    <li><a href="{{ route('forest_law') }}" class="slide-item">ป่าไม้</a></li>
                                    <li><a href="{{ route('gov_project') }}" class="slide-item">โครงการพัฒนาของรัฐ</a></li>
                                    <li><a href="{{ route('expropriate') }}" class="slide-item">เวนคืนที่ดิน</a></li>
                                    <li><a href="{{ route('parcel') }}" class="slide-item">แปลงคง + อช.10, 13</a></li>
                                </ul>
                            </li>
                             <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
